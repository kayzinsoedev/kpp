...
<div class="container">
    <div class="row">
        ...
        <!--    {-->
        <!--        $('html, body').animate({-->
        <!--            scrollTop: $(".showAddedFiles").offset().top-->
        <!--        }, 2000);-->
        <!--    });-->
        <!--</script>-->
        ...
        <div class="box">
            ...
            <div class="col-lg-12">
                ...
                <form class="file_upload_form_test" method="POST" action="<?=base_url('prints/file_validation_test/')?>" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6" style="border-right: dashed">
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                            <div class="input-group">
                                <div class="input-group-addon"><strong>Content</strong></div>
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                            <div class="input-group">
                                ...
                                <select title="finishing" class="form-control" name="finishing" id="finishing">
                                    ...
                                    <option value="Book Bind" >Book Bind (Perfect Bind)</option>
                                    <option value="Ring Bind" >Ring Bind (Plastic Comb)</option>
                        ...
                        <div class="form-group col-md-12">
                            <div class="input-group">
                                <div class="input-group-addon">Remarks / Special Instruction</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                            <div class="input-group">
                                <div class="input-group-addon"><strong>Handouts</strong></div>
                                <input class="form-control file" type="file" id="handouts_file" name="handouts_file[]" multiple>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-md-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="File Name" id="file_name" placeholder="File Name (To Represent on Delivery Order)" value="">
                        </div>
                    </div>
